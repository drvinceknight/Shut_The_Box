...
print("Mean Score with Random autoplay:")
print(mean(Random$Score, na.rm=TRUE))
print("Mean Score with Shortest autoplay:")
print(mean(Shortest$Score, na.rm=TRUE))
print("Mean Score with Longest autoplay:")
print(mean(Longest$Score, na.rm=TRUE))
print("Mean Score with Greedy autoplay:")
print(mean(Greedy$Score, na.rm=TRUE))
